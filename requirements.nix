...
let
  ...
  generated = self: {
    ...
    "asyncio" = python.mkDerivation {
      name = "asyncio-3.4.3";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/da/54/054bafaf2c0fb8473d423743e191fcdf49b2c1fd5e9af3524efbe097bafd/asyncio-3.4.3.tar.gz"; sha256 = "83360ff8bc97980e4ff25c964c7bd3923d333d177aa4f7fb736b019f26c7cb41"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
    ...
    "discord.py" = python.mkDerivation {
      name = "discord.py-1.0.0a1633+gdec14fa";
      src = pkgs.fetchgit { url = "https://github.com/Rapptz/discord.py"; sha256 = "1qlcv0h5m2jdvqk9kayiacl2i5cbdjgv9dbgfa3cy26wrdgmkss2"; rev = "dec14faea90b57d34245b17e58438ee91990764c"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."aiohttp"
    ...
    "websockets" = python.mkDerivation {
      name = "websockets-6.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/4e/2a/56e60bb4c3696bc736998cc13c3fa1a36210609d7e1a3f2519857b420245/websockets-6.0.tar.gz"; sha256 = "8f3b956d11c5b301206382726210dc1d3bee1a9ccf7aadf895aaf31f71c3716c"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
